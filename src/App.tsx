...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState<'shop' | 'admin' | 'cart'>(() => {
  ...
  // Synchronize currentView changes with browser address bar and handle forward/back buttons
  useEffect(() => {
  ...
  // Update URL path without reloading when currentView changes
  useEffect(() => {
    const path = currentView === 'admin' ? '/admin' : currentView === 'cart' ? '/cart' : '/';
  ...
  const [loggedInUser, setLoggedInUser] = useState<any>(() => {
    const saved = sessionStorage.getItem('kipchimatt_user');
  ...
  }, [products, isInitialLoaded, loggedInUser]);
  ...
  }, [orders, isInitialLoaded, loggedInUser]);
  ...
  }, [settings, isInitialLoaded, loggedInUser]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col antialiased">
      ...
      {showOnlineStatusMsg && currentView !== 'admin' && (
      ...
      {currentView === 'admin' ? (
        /* Back-Office Operational Console Dashboard (Fully isolated from storefront) */
        <AdminPortal 
          products={products}
          orders={orders}
          settings={settings}
          ...
          onLogin={(user) => {
            sessionStorage.setItem('kipchimatt_user', JSON.stringify(user));
            setLoggedInUser(user);
          }}
          onLogout={() => {
            sessionStorage.removeItem('kipchimatt_user');
        ...
        <>
          ...
          {currentView === 'shop' ? (
            ...
            <div className="flex-1 flex flex-col">
              ...
              <footer className="bg-plum-dark text-white/70 pt-14 pb-8 mt-auto border-t border-plum/25">
                <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    {/* Column 4: Operational links (Fully removed Admin Console direct button) */}
                    <div className="space-y-4">
                      <h4 className="font-black text-white text-sm tracking-wide uppercase">
                        Supermarket Links
                      </h4>
