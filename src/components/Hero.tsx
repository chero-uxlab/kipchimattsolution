  ...
  return (
    <section className="py-0 w-full">
      <div className="w-full">
        ...
        {/* Carousel */}
        <div className="relative overflow-hidden h-[280px] sm:h-[320px] md:h-[420px] w-full">
          <div 
          ...
          >
            {slides.map((slide) => (
              <div 
                key={slide.id}
                className="min-w-full h-full flex items-center justify-between px-6 py-8 sm:px-12 md:px-20 lg:px-28 text-white relative select-none bg-cover bg-center"
          ...
          <button 
            onClick={prevSlide}
            className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-plum/65 hover:bg-plum/85 text-white flex items-center justify-center cursor-pointer transition-colors z-20 border border-white/10"
          ...
          <button 
            onClick={nextSlide}
            className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-plum/65 hover:bg-plum/85 text-white flex items-center justify-center cursor-pointer transition-colors z-20 border border-white/10"
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 mt-6">
        {/* Promo Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gradient-to-br from-plum-fade to-plum/10 border border-plum/25 rounded-xl p-6 relative overflow-hidden flex flex-col justify-between shadow-sm group">
            <div className="z-10">
            ...
            <button 
              ...
              className="w-fit bg-plum hover:bg-plum-dark text-white text-[11px] font-extrabold px-4 py-2 rounded-lg cursor-pointer transition-colors shadow-sm"
            >
              Shop Now
            </button>
          ...
          <div className="bg-gradient-to-br from-plum-dark/15 to-plum-fade border border-plum/30 rounded-xl p-6 relative overflow-hidden flex flex-col justify-between shadow-sm group">
            <div className="z-10">
