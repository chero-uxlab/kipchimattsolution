                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-3 gap-2">
                      <button 
                        ...
                        className={`py-1.5 px-2.5 sm:px-3 rounded-lg font-bold text-[10px] flex items-center justify-center gap-1 flex-row flex-nowrap whitespace-nowrap cursor-pointer transition-colors shrink-0 ${isOutOfStock ? 'bg-gray-100 text-gray-400 cursor-not-allowed border border-gray-200/50' : 'bg-plum/5 hover:bg-plum/10 text-plum'}`}
                      >
