      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[92vh] overflow-y-auto animate-scale-up relative border border-gray-150 flex flex-col scrollbar-none">
        ...
        <div className="p-5 sm:p-8 grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 flex-1">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="aspect-square w-full rounded-2xl bg-gray-50 dark:bg-gray-850 border border-gray-150 dark:border-gray-800 overflow-hidden relative shadow-sm group">
              <img 
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div className="p-2.5 bg-gray-50 dark:bg-gray-850 border border-gray-100 dark:border-gray-800 rounded-xl">
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button 
                  ...
                  className={`flex-1 min-w-[120px] sm:min-w-[150px] py-3 px-4 sm:px-6 rounded-xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 flex-row flex-nowrap whitespace-nowrap cursor-pointer shadow-md transition-all ${isOutOfStock ? 'bg-gray-100 text-gray-400 border border-gray-200 cursor-not-allowed' : 'bg-plum text-white hover:bg-plum-dark hover:shadow-lg'}`}
                >
        ...
        {suggestedItems.length > 0 && (
          <div className="border-t border-gray-150 p-5 sm:p-8 bg-plum/5 dark:bg-pink-950/10">
            <h3 className="font-black text-gray-800 dark:text-gray-100 text-sm mb-4 flex items-center gap-1.5 uppercase tracking-wide">
              <Sparkles className="w-4 h-4 text-plum dark:text-pink-300 animate-pulse" />
                      ...
                      <React.Fragment key={item.id}>
                        ...
                        <div 
                          ...
                          className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer select-none transition-all max-w-[240px] ${
                            isChecked 
                              ? 'bg-plum/10 dark:bg-pink-950/25 border-plum dark:border-pink-800/50' 
                ...
                <div className="md:col-span-4 border-t md:border-t-0 md:border-l border-gray-150 dark:border-gray-800 pt-4 md:pt-0 md:pl-6 flex flex-col justify-center space-y-3">
                  <div className="space-y-1">
                    ...
                    <div className="flex items-baseline gap-2">
                      <span className="text-lg sm:text-xl font-black text-plum dark:text-pink-400">
                        {formatMoney(
                          product.price + 
                          suggestedItems
                  ...
                  <button
                    ...
                    className="w-full bg-plum hover:bg-plum-light text-white font-black text-xs uppercase tracking-wider py-3 px-4 rounded-xl shadow-md transition-colors cursor-pointer flex items-center justify-center gap-2"
                  >
        ...
        {relatedProducts.length > 0 && (
          <div className="border-t border-gray-150 dark:border-gray-800 p-5 sm:p-8 bg-gray-50/50 dark:bg-gray-900/50">
            <h3 className="font-black text-gray-800 dark:text-gray-100 text-sm mb-4 flex items-center gap-1.5 uppercase tracking-wide">
              ...
              {relatedProducts.map(p => {
                ...
                return (
                  <div 
                    ...
                    className="bg-white dark:bg-white rounded-2xl border border-gray-150 dark:border-gray-200/60 p-3 hover:border-plum hover:shadow-lg cursor-pointer transition-all flex flex-col justify-between group"
                  >
                    <div className="aspect-square bg-white dark:bg-white rounded-lg overflow-hidden relative mb-2 border border-gray-100 dark:border-gray-200/40">
                      <img 
                    ...
                    <div>
                      ...
                      <h4 className="font-bold text-gray-800 dark:text-gray-100 text-[11px] line-clamp-2 leading-tight h-7 mt-0.5 group-hover:text-plum transition-colors">
                        {p.name}
                      </h4>
                    </div>

                    <div className="flex items-baseline justify-between mt-2 pt-1 border-t border-gray-50 dark:border-gray-850">
