...
export default function CartPage({
  ...
  if (placedOrder) {
    ...
    return (
      <div className="flex-1 w-full bg-slate-50 flex flex-col justify-between min-h-[92vh] animate-fade-in font-sans">
        ...
        <footer className="bg-plum-dark text-white/40 py-6 px-4 text-center text-[10px] font-bold border-t border-plum/25">
  ...
  return (
    <div className="flex-1 w-full bg-slate-50 flex flex-col justify-between min-h-[92vh] animate-fade-in font-sans">
      ...
      <main className="w-full flex-1 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8">
      ...
      <footer className="bg-plum-dark text-white/40 py-8 px-4 text-center text-[10px] font-bold border-t border-plum/25 w-full">
